...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {
            'admin-css': {
                src: ['bower_components/ng-admin/build/ng-admin.min.css', '<%= yeoman.app %>/ag-admin/styles/bootstrap.css'],
                dest: '<%= yeoman.app %>/ag-admin/styles/admin.cache.css'
            },
            'admin-js': {
                src: ['bower_components/jquery/jquery.js', 'bower_components/ng-admin/build/ng-admin.min.js', 'bower_components/checklist-model/checklist-model.js', 'bower_components/bootstrap-ui-datetime-picker/dist/datetime-picker.js', 'bower_components/angular-http-auth/src/http-auth-interceptor.js', 'bower_components/angular-cookies/angular-cookies.min.js', '<%= yeoman.app %>/ag-admin/scripts/ng-admin.app.js', '<%= yeoman.app %>/ag-admin/scripts/services/admin_token_service.js', '<%= yeoman.app %>/ag-admin/scripts/services/oauth_token_injector.js', '<%= yeoman.app %>/ag-admin/scripts/services/interceptor.js', '<%= yeoman.app %>/ag-admin/scripts/controllers/users_login.js', '<%= yeoman.app %>/ag-admin/scripts/controllers/capacity_reports.js', '<%= yeoman.app %>/ag-admin/scripts/controllers/demographics_reports.js', '<%= yeoman.app %>/ag-admin/scripts/controllers/financial_reports.js', '<%= yeoman.app %>/ag-admin/scripts/controllers/participants_reports.js', '<%= yeoman.app %>/ag-admin/scripts/controllers/sales_detailed_reports.js', '<%= yeoman.app %>/ag-admin/scripts/controllers/sales_reports.js', '<%= yeoman.app %>/ag-admin/scripts/controllers/visitors_reports.js', '<%= yeoman.app %>/ag-admin/scripts/controllers/event_zone.js', '<%= yeoman.app %>/ag-admin/scripts/controllers/users_logout.js', '<%= yeoman.app %>/ag-admin/scripts/gvchart.js', '<%= yeoman.app %>/ag-admin/scripts/controllers/invitaion-send.js'],
    ...
    // The task to check errors in source files.
    grunt.registerTask('pre-commit', ['jshint', 'eslint', 'phplint', 'complexity', 'jsbeautifier:pre-merge']);
};