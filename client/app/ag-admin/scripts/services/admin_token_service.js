...
/**
 * @ngdoc service
 * @name tixmallAdmin.adminTokenService
 * @description
 * # adminTokenService
 * This service created token on app start and its a resolve service for all end points
 */
angular.module('tixmallAdmin')
    .service('adminTokenService', function($rootScope, $http, $q, $cookies) {
        //jshint unused:false
        var promise;
        var promiseSettings;
