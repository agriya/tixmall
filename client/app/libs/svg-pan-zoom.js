...
(function e(t, n, r) {
    ...
    2: [function(require, module, exports) {
        ...
        module.exports = {
            enable: function(instance) {
                ...
                style.textContent = '.svg-pan-zoom-control { cursor: pointer; fill: red; fill-opacity: 1; } .svg-pan-zoom-control:hover { fill-opacity: 1; } .svg-pan-zoom-control-background { fill: white; fill-opacity: 1; } .svg-pan-zoom-control-background { fill-opacity: 1; }'
                defs.appendChild(style)
                // Zoom Group
                var zoomGroup = document.createElementNS(SvgUtils.svgNS, 'g');
                zoomGroup.setAttribute('id', 'svg-pan-zoom-controls');
                zoomGroup.setAttribute('transform', 'translate(' + (instance.width - 70) + ' ' + (10) + ') scale(0.75)');
            ...
            _createZoomReset: function(instance) {
                ...
                resetPanZoomControlBackground.setAttribute('x', '4');
                resetPanZoomControlBackground.setAttribute('y', '3');
                resetPanZoomControlBackground.setAttribute('width', '175'); // larger than expected because the whole group is transformed to scale down
                resetPanZoomControlBackground.setAttribute('height', '50');
    ...
    3: [function(require, module, exports) {
        ...
        ShadowViewport.prototype.cacheViewBox = function() {
            ...
            if (svgViewBox) {
                var viewBoxValues = svgViewBox.split(/[\s\,]/)
                    .filter(function(v) {
                        return v
                    })
                    .map(parseFloat)
            ...
            if (willZoom || willPan) {
                ...
                if (willPan) {
                    ...
                    if (preventPan === false) {
                        ...
                        newCTM.e = this.getPan()
                            .x
                        newCTM.f = this.getPan()
                            .y
    ...
    4: [function(require, module, exports) {
        ...
        SvgPanZoom.prototype.handleMouseWheel = function(evt) {
            ...
            var inversedScreenCTM = this.svg.getScreenCTM()
                .inverse(),
                relativeMousePoint = SvgUtils.getEventPoint(evt, this.svg)
        ...
        SvgPanZoom.prototype.zoomAtPoint = function(zoomScale, point, zoomAbsolute) {
            ...
            var oldCTM = this.viewport.getCTM(),
                ...
                modifier = this.svg.createSVGMatrix()
        ...
        SvgPanZoom.prototype.computeFromRelativeZoom = function(zoom) {
            return zoom * this.viewport.getOriginalState()
                .zoom
        }
        /**
        ...
        SvgPanZoom.prototype.handleDblClick = function(evt) {
            ...
            var point = SvgUtils.getEventPoint(evt, this.svg)
                .matrixTransform(this.svg.getScreenCTM()
                    .inverse())
        ...
        SvgPanZoom.prototype.handleMouseDown = function(evt, prevEvt) {
            ...
            if (this.options.dblClickZoomEnabled && Utils.isDblClick(evt, prevEvt)) {
                ...
                this.stateOrigin = SvgUtils.getEventPoint(evt, this.svg)
        ...
        SvgPanZoom.prototype.panUp = function(point) {
            var state = this.viewport.getState();
            var viewportCTM = this.viewport.getCTM();
            viewportCTM.e = state.x;
            viewportCTM.f += point.y;
            this.viewport.setCTM(viewportCTM);
        }
        SvgPanZoom.prototype.panDown = function(point) {
            var state = this.viewport.getState();
            var viewportCTM = this.viewport.getCTM();
            viewportCTM.e = state.x;
            viewportCTM.f -= point.y;
        ...
        SvgPanZoom.prototype.panLeft = function(point) {
            var state = this.viewport.getState();
            var viewportCTM = this.viewport.getCTM();
            viewportCTM.e -= state.x;
            viewportCTM.f = point.y;
            console.log(viewportCTM);
            this.viewport.setCTM(viewportCTM);
        }
        SvgPanZoom.prototype.panRight = function(point) {
            var state = this.viewport.getState();
            var viewportCTM = this.viewport.getCTM();
            viewportCTM.e += state.x;
            viewportCTM.f = point.y;
        ...
        SvgPanZoom.prototype.getPublicInstance = function() {
            ...
            if (!this.publicInstance) {
                this.publicInstance = this.pi = {
                    ...
                    panUp: function() {
                        var viewBox = that.viewport.getViewBox();
                        /*, offsetX = (that.width - (viewBox.width + viewBox.x * 2) * that.getZoom()) * 0.5
                        , offsetY = (that.height - (viewBox.height + viewBox.y * 2) * that.getZoom()) * 0.5*/
                        that.panBy({
                            x: viewBox.x,
                            y: parseFloat(viewBox.y + 10)
                        });
                        return that.pi;
                    },
                    panDown: function() {
    ...
    5: [function(require, module, exports) {
        ...
        module.exports = {
            ...
            getOrCreateViewport: function(svg, selector) {
                    ...
                    if (!viewport) {
                        var childNodes = Array.prototype.slice.call(svg.childNodes || svg.children)
                            .filter(function(el) {
                    ...
                    if (!viewport) {
                        var viewportId = 'viewport-' + new Date()
                            .toISOString()
                            .replace(/\D/g, '');
                    ...
                    if (viewport.getAttribute('class')) {
                        classNames = viewport.getAttribute('class')
                            .split(' ')
                    }
