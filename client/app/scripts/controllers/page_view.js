...
/**
 * @ngdoc function
 * @name tixmall.controller:PageViewCtrl
 * @description
 * # PageViewCtrl
...
angular.module('tixmall')
    .controller('PageViewCtrl', ['$scope', '$rootScope', '$stateParams', 'page', 'flash', '$filter', function($scope, $rootScope, $stateParams, page, flash, $filter) {
            // used controller as syntax, assigned current scope to variable pageview
            var pageview = this;
            /**
             * @ngdoc method
             * @name PageViewCtrl.pageview.init
             * @methodOf module.PageViewCtrl
             * @description
             * This method static page content.
             *
             */
