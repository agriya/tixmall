...
$thumbsizes = array(
    'News' => array(
        ...
        'small_thumb' => '32x32',
        'normal_thumb' => '64x64',
        'medium_thumb' => '411x213',
        'large_thumb' => '1425x300'
    ) ,
    'Event' => array(
        'micro_thumb' => '16x16',
        'small_thumb' => '32x32',
        'normal_thumb' => '190x160',
        'medium_thumb' => '332x238',
        'large_thumb' => '1425x730',
        'medium_home_thumb' => '428x492',
        'large_home_thumb' => '838x492',
        'lower_medium_thumb' => '238x238',
        'extra_medium_thumb' => '555x311',
        'extra_normal_thumb' => '225x225',
        'past_event_thumb' => '250x90',
        'seat_event_thumb' => '300x200' 
    ) ,
    'Venue' => array(
        'micro_thumb' => '16x16',
        'small_thumb' => '32x32',
        'normal_thumb' => '190x160',
        'medium_thumb' => '240x114',
        'large_thumb' => '635x250',
        'big_thumb' => '676x458',
        'original' => '1170x740'
    ) ,
    ...
    'VenueZonePreview' => array(
        'original' => '240x114'
    ) ,
    'EventFloorPlan' => array(
        'lower_large_thumb' => '1000x400'
    ) ,
    'TicketPrices' => array(
        'lower_large_thumb' => '1000x400'
    )
...
if ($hash == md5($model . $id . $ext . $size)) {
    ...
    $s_result = pg_query_params($db_lnk, 'SELECT filename, dir FROM attachments WHERE foreign_id = $1 AND class = $2', $condition);
